...
class Config:
    ...
    def _construct_augmented_config_path(self, file_path: str, infix: str="_augmented") -> str:
        """ """
    ...
    def augment_config(self) -> ConfigModel:
        ...
        augmented_config_path = self._construct_augmented_config_path(file_path=self.config_path)

        self._save_config(file_path=augmented_config_path, config=augmented_config)
        augmented_config: ConfigModel = self.load_config(file_path=augmented_config_path)
